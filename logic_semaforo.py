...
def generar_pdf(datos, carpeta):
    ...
    elementos = [
        Paragraph(
            "SECRETARIA PARA LA TRANSFORMACIÓN DE LAS CIUDADES HUMANAS Y SERVICIOS- "
            "DIRECCIÓN DE INGENIERÍA MUNICIPAL- DIRECCIÓN DE HABITAT Y VIVIENDA · RIF G-20002924-2",
